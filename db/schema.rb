...
ActiveRecord::Schema.define(version: 2020_10_01_093734) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.integer "hotel_id"
    t.integer "single_bed_room", default: 0
    t.integer "double_bed_room", default: 0
    t.integer "suite_room", default: 0
    t.integer "dormitory", default: 0
